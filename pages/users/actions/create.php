  ...
  <div class="shell">
    ...
    <main class="page">
      ...
      <div class="page-header">
        <div>
          <h2 class="page-title">Criar <span>Usuário</span></h2>
      ...
      <!-- Form Card -->
      <div class="form-card">
        <form id="create-form" method="post" action="/pages/users/actions/store.php">
          <div class="form-grid">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <button class="input-icon-right" type="button" onclick="this.previousElementSibling.type = this.previousElementSibling.type === 'password' ? 'text' : 'password'">
