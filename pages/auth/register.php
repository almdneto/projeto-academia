...
<body class="bg-background text-on-background font-body-md overflow-y-auto lg:overflow-hidden">
  <main class="flex min-h-screen lg:h-screen w-full">
    ...
    <section class="w-full lg:w-2/5 flex flex-col justify-center items-center bg-background border-l border-outline-variant/20 px-4 sm:px-6 lg:px-gutter py-8 lg:py-0">
      <div class="w-full max-w-md px-4 sm:px-6">
        ...
        <!-- Form -->
        <form class="space-y-6 mt-8" id="registerForm">

          <!-- Nome completo -->
          <div class="space-y-2">
            <label class="font-label-lg text-label-lg text-on-surface flex items-center gap-2" for="full_name">
            ...
            <input
              ...
              id="full_name" name="full_name" type="text" placeholder="Digite seu nome completo" required>
          </div>
          ...
          <!-- Confirmar senha -->
          <div class="space-y-2">
            <label class="font-label-lg text-label-lg text-on-surface flex items-center gap-2" for="confirm_password">
          ...
          <div class="flex items-start gap-3">
            <div class="relative mt-0.5">
              <input class="peer hidden" type="checkbox" id="terms" required>
              <div
  ...
  <script>
    ...
    form.addEventListener('submit', (e) => {
      ...
      btn.disabled = true;
      btn.innerHTML = `<div class="w-6 h-6 border-4 border-on-primary-fixed border-t-transparent rounded-full animate-spin"></div> PROCESSANDO...`;
